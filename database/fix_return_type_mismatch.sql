-- Fix for "Returned type text does not match expected type character varying" error
-- The issue is in the RETURN QUERY statement where data types don't match exactly

-- Drop the existing function
DROP FUNCTION IF EXISTS create_user_with_wallet(VARCHAR(42), TEXT, TEXT, VARCHAR(64), VARCHAR(100), VARCHAR(255));

-- Recreate with proper return type casting
...
-- Also fix the generate_custom_id function to ensure proper return type
