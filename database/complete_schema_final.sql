-- Complete SignTusk Database Schema (FINAL FIXED VERSION)
-- Combines User Identity Management + Document Signing System
-- FIXES: Ambiguous custom_id error in database functions
...
-- ============================================================================
-- CUSTOM FUNCTIONS (FIXED FOR AMBIGUITY)
-- ============================================================================

-- Function to generate unique custom ID (FIXED)
...
-- Function to create user profile with wallet (FIXED FOR AMBIGUITY)
...
VALUES ('1.2.0', 'Complete SignTusk schema with fixed ambiguous custom_id error');
...
COMMENT ON TABLE challenges IS 'Stores authentication challenges for wallet verification';
...
COMMENT ON FUNCTION generate_custom_id() IS 'Generates unique 15-character custom ID (FIXED for ambiguity)';
COMMENT ON FUNCTION create_user_with_wallet(VARCHAR(42), TEXT, TEXT, VARCHAR(64), VARCHAR(100), VARCHAR(255)) IS 'Creates user profile with wallet atomically (FIXED for ambiguity)';
